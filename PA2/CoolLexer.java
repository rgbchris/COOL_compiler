 ...
 *  work.  */
  ...
  return new Symbol(TokenConstants.ERROR, "String contains null character."); 
					...
					case -59:
						break;
					case 59:
						{ string_buf.append('\t'); /* tab */ }
					case -60:
						break;
					case 60:
						{ string_buf.append('\f'); /* formfeed */ }
					case -61:
						break;
					case 61:
						{ string_buf.append('\013'); /* vertical tab */ }
					case -62:
						break;
					case 62:
					...
					case -63:
						break;
					case 63:
						{ string_buf.append('\022'); /* ^R device control 2 */ }
					case -64:
						break;
					case 64:
